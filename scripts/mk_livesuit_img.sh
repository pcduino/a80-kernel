...
DRAGON=${PWD}/allwinner-tools/pack/pctools/linux/eDragonEx/dragon
FSBUILD=${PWD}/allwinner-tools/pack/pctools/linux/fsbuild200/fsbuild
...
PACK_TOOLS_DIR="${PWD}/allwinner-tools/pack"
TOOLS_DIR="${PACK_TOOLS_DIR}/pctools/linux"
BOARD_DIR="${PWD}/allwinner-tools/pack/chips/sun9iw1p1/configs/pcduino8"
...
make_boot0_boot1()
{
	...
	cp -rf ${PACK_TOOLS_DIR}/chips/sun9iw1p1/bin/boot0_nand_sun9iw1p1.bin ${BUILD_DIR}/nand_boot0.bin
	cp -rf ${PACK_TOOLS_DIR}/chips/sun9iw1p1/bin/boot0_sdcard_sun9iw1p1.bin ${BUILD_DIR}/card_boot0.fex
...
#	cp -rf ${SOURCE_DIR}/eGon/storage_media/sdcard/boot1.bin ${BUILD_DIR}/card_boot1.fex
	...
	update_23 ${BUILD_DIR_LOCAL}/sys_config1.bin ${BUILD_DIR_LOCAL}/nand_boot0.bin 
	update_23 ${BUILD_DIR_LOCAL}/sys_config1.bin ${BUILD_DIR_LOCAL}/card_boot0.fex  SDMMC_CARD
}
...
do_pack_a80()
{
    ...
    mkdir -p ${BUILD_DIR}
    cp -f ${BOARD_DIR}/* ${BUILD_DIR}
    cp ${PWD}/sunxi-boards/sys_config/${SOC}/${BOARD}.fex ${BUILD_DIR}/sys_config.fex
    cp -r ${TOOLS_DIR}/* ${BUILD_DIR}
    cd ${BUILD_DIR}
